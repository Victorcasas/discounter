...
describe "Checkout" do
  it "should require promotion rules on create" do
    ...
    promotion_rules = [ Discounter::DiscountRule.new, Discounter::DiscountRule.new ]
    checkout = Discounter::Checkout.new promotion_rules
  end

  describe "basic operations" do
    before do
      @checkout = Discounter::Checkout.new []
    end

    it "should be able to scan items" do
      @checkout.must_respond_to "scan"

      item = Discounter::Item.new("001", "Test Item", 9.25)
      @checkout.scan item
    ...
    it "it should be able to calculate total" do
      ...
      @checkout.scan Discounter::Item.new("001", "Test item1", 10.00)
      @checkout.scan Discounter::Item.new("002", "Test item2", 1.32)
      @checkout.scan Discounter::Item.new("003", "Test item3", 17.25)
  ...
  describe "promotional rules" do
    ...
    before do
      ...
      @promotional_rules << Discounter::PercentajeDiscountRule.new(60.00, 10.00)
    ...
    it "should make a 10% discount from total purchase if spended over 60 pounds" do
      checkout = Discounter::Checkout.new([ Discounter::PercentajeDiscountRule.new(60.00, 10.00) ])
    ...
    it "should drop price by factor on multiple items" do
      checkout = Discounter::Checkout.new([ Discounter::ItemDiscountRule.new("001", 2, 0.5) ])
    ...
    it "should be valid for test case 1" do
      @checkout.scan Discounter::Item.new("001", "Lavender heart", 9.25)
      @checkout.scan Discounter::Item.new("002", "Personalised cufflinks", 45.00)
      @checkout.scan Discounter::Item.new("003", "Kids T-shirt", 19.95)
